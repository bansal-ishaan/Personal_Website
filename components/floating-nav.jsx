...
import { Terminal, User, Code, Briefcase, Award, Trophy, Mail, Zap, Power } from "lucide-react"

const navItems = [
  { id: "hero", icon: Terminal, label: "BOOT", color: "text-green-400" },
  { id: "education", icon: User, label: "EDU", color: "text-blue-400" },
  { id: "skills", icon: Code, label: "SKILLS", color: "text-purple-400" },
  { id: "projects", icon: Briefcase, label: "BUILDS", color: "text-cyan-400" },
  { id: "achievements", icon: Award, label: "WINS", color: "text-yellow-400" },
  { id: "leadership", icon: Trophy, label: "LEAD", color: "text-pink-400" },
  { id: "contact", icon: Mail, label: "PING", color: "text-red-400" },
]
